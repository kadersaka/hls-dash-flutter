...
class RafsanTemplateDashPage extends StatefulWidget {
  final String url;

  const RafsanTemplateDashPage({super.key, required this.url});
  @override
  _RafsanTemplateDashPageState createState() => _RafsanTemplateDashPageState();
}

class _RafsanTemplateDashPageState extends State<RafsanTemplateDashPage> {
