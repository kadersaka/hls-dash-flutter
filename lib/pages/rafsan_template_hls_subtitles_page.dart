...
class RafsanHlsTemplateSubtitlesPage extends StatefulWidget {
  final String url;

  const RafsanHlsTemplateSubtitlesPage({super.key, required this.url});
  @override
  _RafsanHlsTemplateSubtitlesPageState createState() => _RafsanHlsTemplateSubtitlesPageState();
}

class _RafsanHlsTemplateSubtitlesPageState extends State<RafsanHlsTemplateSubtitlesPage> {
