import 'dart:io';
import 'package:testflutter3/pages/rafsan_dash_page.dart';
import 'package:testflutter3/pages/rafsan_hls_subtitles_page.dart';
import 'package:testflutter3/pages/url-form.dart';
...
class _WelcomePageState extends State<WelcomePage> {
  ...
  List<Widget> buildExampleElementWidgets() {
    return [
      _buildExampleElementWidget("Rafsan HLS page", () {
        _navigateToPage(RafsanHlsSubtitlesPage());
      }),
      _buildExampleElementWidget("Rafsan Dash  page ", () {
        _navigateToPage(RafsanDashPage());
      }),
